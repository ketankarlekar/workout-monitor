...
function pullGroups(completed: boolean) {
  return [
...
function legsGroups(completed: boolean) {
  return [
...
function saturdayGroups(completed: boolean) {
  return [
 ...
 */
export const DUMMY_SESSIONS = Array.from({ length: 30 }, (_, i) => {
  const day = i + 1;
...
console.log(JSON.stringify(DUMMY_SESSIONS));
